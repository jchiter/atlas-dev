...
if ( ! class_exists( 'Realia' ) ) {
	...
	final class Realia {
		...
		public function includes() {
			...
			require_once REALIA_DIR . 'includes/class-realia-social.php';
