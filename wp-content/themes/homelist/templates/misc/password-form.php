...
<form method="post" action="<?php the_permalink(); ?>" class="change-password-form">
	<div class="form-group">
		<label for="change-password-form-old-password"><?php echo esc_html__( 'Old password', 'homelist' ); ?></label>
		<input id="change-password-form-old-password" class="form-control" type="password" name="old_password" required="required">
	</div><!-- /.form-control -->

	<div class="form-group">
		<label for="change-password-form-new-password"><?php echo esc_html__( 'New password', 'homelist' ); ?></label>
	...
	<div class="form-group">
		<label for="change-password-form-retype-password"><?php echo esc_html__( 'Retype password', 'homelist' ); ?></label>
	...
	<button type="submit" name="change_password_form" class="button"><?php echo esc_html__( 'Change Password', 'homelist' ); ?></button>
</form>
