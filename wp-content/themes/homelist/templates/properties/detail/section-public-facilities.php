                ...
                <div class="property-public-facility-wrapper">
                    <div class="property-public-facility">
                        <div class="property-public-facility-title">
                            <?php $term = get_term( $facility[REALIA_PROPERTY_PREFIX . 'public_facilities_key'], 'facilities' ); ?>
                            <span><?php echo empty( $facility[REALIA_PROPERTY_PREFIX . 'public_facilities_key'] ) ? '' : esc_attr( $term->name ); ?></span>
