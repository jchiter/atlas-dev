        ...
        <div class="property-valuation">
            ...
            <?php foreach ( $valuation as $group ) : ?>
                <dl class="property-valuation-item">
                    <?php $term = get_term( $group[REALIA_PROPERTY_PREFIX . 'valuation_key'], 'valuations' ); ?>
                    <dt><?php echo empty( $group[REALIA_PROPERTY_PREFIX . 'valuation_key'] ) ? '' : esc_attr( $term->name ); ?></dt>
                    <dd>
