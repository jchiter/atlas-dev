...
<div class="field col-md-3 col-sm-3 col-xs-12">
	<div class="form-group">
		<?php if ( 'labels' == $input_titles ) : ?>
			<label for="<?php echo ! empty( $field_id_prefix ) ? $field_id_prefix : ''; ?><?php echo esc_attr( $args['widget_id'] ); ?>_property_type"><?php echo esc_html__( 'Property type', 'homelist' ); ?></label>
		<?php endif; ?>
		...
		<select class="form-control" name="filter-property-type" id="<?php echo ! empty( $field_id_prefix ) ? $field_id_prefix : ''; ?><?php echo esc_attr( $args['widget_id'] ); ?>_property_type">
			...
			<option value="">
				<?php if ( 'placeholders' == $input_titles ) : ?>
					<?php echo esc_html__( 'Property type', 'homelist' ); ?>
				<?php else : ?>
					<?php echo esc_html__( 'All property types', 'homelist' ); ?>
				<?php endif; ?>
			</option>
