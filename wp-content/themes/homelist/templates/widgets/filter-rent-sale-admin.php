...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'button_text' ) ); ?>">
		<?php echo esc_html__( 'Button text', 'homelist' ); ?>
	</label>
...
<!-- INPUT TITLES -->
<label><?php echo esc_html__( 'Input titles', 'homelist' ); ?></label>
...
<ul>
	<li>
		<label>
			...
			<?php echo esc_html__( 'Labels', 'homelist' ); ?>
		</label>
	</li>
		...
		<label>
			<input  type="radio"
				...
				<?php echo ( 'placeholders' == $input_titles ) ? 'checked="checked"' : ''; ?>
			        id="<?php echo esc_attr( $this->get_field_id( 'input_titles' ) ); ?>"
			        name="<?php echo esc_attr( $this->get_field_name( 'input_titles' ) ); ?>">
			<?php echo esc_html__( 'Placeholders', 'homelist' ); ?>
		</label>
	</li>
</ul>
...
<p>
	...
	<br>
	<small><?php echo esc_html__( 'Additional classes e.g. <i>transparent-background map-overlay</i>', 'homelist' ); ?></small>
</p>
...
<h3><?php echo esc_html__( 'Rent Fields', 'homelist' ); ?></h3>
...
<h3><?php echo esc_html__( 'Sale Fields', 'homelist' ); ?></h3>
