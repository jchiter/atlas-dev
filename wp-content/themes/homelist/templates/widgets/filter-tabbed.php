            ...
            <div class="tabs <?php echo esc_attr( $classes );?>">
	            <ul id="myTab" class="nav nav-tabs nav-justified">
		            ...
		            <?php foreach( $contract_options as $contract_key => $contract_value ): ?>
			            ...
			            ?>
			            <li class="<?php echo esc_attr( $contract_key_lower ); ?> <?php if ( $is_active ): ?>active<?php endif; ?>"><a href="#<?php echo esc_attr( $args['widget_id'] ); ?>-<?php echo esc_attr( $contract_key_lower ); ?>" data-toggle="tab"><?php echo esc_attr( $contract_value ); ?></a></li>
		            <?php endforeach; ?>
	            ...
	            <?php foreach( $contract_options as $contract_key => $contract_value ): ?>
		            ...
		            <div class="tab-pane fade in <?php echo esc_attr( $contract_key_lower ); ?>-tab <?php if ( $is_active ) : ?>active<?php endif; ?>" id="<?php echo esc_attr( $args['widget_id'] ); ?>-<?php echo esc_attr( $contract_key_lower ); ?>">
			            <form method="get" action="<?php echo get_post_type_archive_link( 'property' ); ?>">
				            ...
				            <input type="hidden" name="filter-contract" value="<?php echo esc_attr( $contract_key ); ?>">
